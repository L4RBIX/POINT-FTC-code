...
public class BekaAutoCloseRed extends OpMode {
    ...
    private final Pose startPose    = new Pose(144-117.3,   132.84, Math.toRadians(233));
    private final Pose shootingpose = new Pose(144-96.831,  97.598,  Math.toRadians(140));
    private final Pose l2p          = new Pose(144-92.831,  60.632,  Math.toRadians(0));
    private final Pose l2ep         = new Pose(144-129.5,   60.632,  Math.toRadians(0));
    private final Pose gatep        = new Pose(144-125,     71,      Math.toRadians(0));
    private final Pose cp1          = new Pose(144-103,     70,      Math.toRadians(0));
    private final Pose cp2          = new Pose(144-86.093,  59.824,  Math.toRadians(0));
    private final Pose l1p          = new Pose(144-99.022,  84.984,  Math.toRadians(0));
    private final Pose l1ep         = new Pose(144-120.400, 84.984,  Math.toRadians(0));
    private final Pose l3p          = new Pose(144-98.639,  38.472,  Math.toRadians(0));
    private final Pose l3ep         = new Pose(144-130,     38.472,  Math.toRadians(0));
    private final Pose parkingpose  = new Pose(144-124,     97,      Math.toRadians(90));

    public static Pose endpose = new Pose(144-124, 97, Math.toRadians(90));
