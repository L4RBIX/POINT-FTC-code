...
@Autonomous(name = "0+6 BLUE", group = "blue")
public class BekaAuto6farBLUE extends OpMode {
    ...
    private final Pose startPose    = new Pose(144-89.76,   7.82,   Math.toRadians(90));
    private final Pose shootingpose = new Pose(144-85.737,  16.105, Math.toRadians(113));
    private final Pose hp           = new Pose(144-132.026, 19.526, Math.toRadians(220));
    private final Pose hp2          = new Pose(144-133.658, 7.289,  Math.toRadians(180));
    private final Pose hp3          = new Pose(144-127.658, 7.289,  Math.toRadians(180));
    private final Pose parkingpose  = new Pose(144-86.947,  33.500, Math.toRadians(90));

    public static Pose endpose = new Pose(144-86.947, 33.500, Math.toRadians(90));
